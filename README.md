...
-  **[structural health monitoring device](https://github.com/riyaanjain/StructureIQ_Xnode_PCB)**: a startup where i took care of all the hardware. some keywords: pcbs, components, breadboards, oscilloscopes, multimeters, microcontrollers, enclosure
